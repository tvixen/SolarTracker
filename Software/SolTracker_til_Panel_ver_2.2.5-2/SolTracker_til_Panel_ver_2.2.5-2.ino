//*************************************************************************
// Version: Arduino IDE 1.6.4 / 1.6.8 Up to 1.6.11
//
// Author: Tim Milgart
//
...
// Update 16-08-2016
// Ny version 2.2.5-1 Rettet i beregningen af UP/Down EW ...så U/D også kommer i brug.
// Update 16-08-2016
// Ny version 2.2.5-2 UP/Down kørte ud af top gevind. END reach virker ikke !. Har taget if (EWinPosition && UDinPosition) ud igen og indsat if (EWinPosition) i stedet, så UP/DOWN ikke regulerer hele tiden.
// Update 18-08-2016
// Ser ud til at virke med kun "if (EWinPosition)" desværre regulerer den kun UP/DOWN når den regulerer E/W, men det kan man leve med, da den så heller ikke bruger strøm.
// aktiveret StopMotorUD(); i  if (LightAverage < 650 ) 
// Update 20-08-2016 
// Nu kontakt position på U/D kontakten
//  Uploadet  20-08-2016 
...
//  while(dipSwitchEastState < 1);  // Hop videre når kontakt går høj = end stop
  ...
  Serial.println("Ver SolTracker_til_Panel_ver 2.2.5-2");
   ...
   if (LightAverage < 650 ) 
    {
     ...
     StopMotorEW();  // Stop motor, så den ikke fortsætter hvis der kommer en sky
     StopMotorUD();  // Stop motor, så den ikke fortsætter hvis der kommer en sky.....Denne Kunne overvejes efter den gik forbi kontakten 16/8-16
     ResetRelayEW(); // Reset relæ så det ikke trækker strøm hele tiden.    
     ...
     Serial.println(" "); 
     Serial.println("No Sun ... And now EXIT  ");     
     Serial.println(" ");     
     Serial.println(" ");   
...
//********* Her kommer den rigtige beregning på panelets hældning  UD/DOWN  *********************
...
//********* Her kommer den rigtige beregning på panelets drejning    East/West  *********************  
  ...
  //if (EWinPosition && UDinPosition)   // brug denne når UP/Down og E/W virker
