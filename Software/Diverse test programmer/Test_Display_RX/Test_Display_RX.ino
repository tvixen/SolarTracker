...
void setup(void) 
{
 //Initialize ports and variables  
  ...
  pinMode(DisplayRD, OUTPUT);  // LED så jeg kan se om det er gået godt
...
//   u8g2.print("WD");
   ...
   u8g2.drawDisc(17,128,11,U8G_DRAW_UPPER_LEFT | U8G_DRAW_UPPER_RIGHT );
